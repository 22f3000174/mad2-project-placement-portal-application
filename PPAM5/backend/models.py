...
class JobApplication(db.Model):
    ...
    interview_time = db.Column(db.String(100), nullable=True)

    # add these here
    interview_mode = db.Column(db.String(300), nullable=True)
    interview_description = db.Column(db.Text, nullable=True)

    feedback = db.Column(db.Text, nullable=True)
    
    offer_letter_path = db.Column(db.String(500), nullable=True)
    offer_letter_message = db.Column(db.Text, nullable=True)
